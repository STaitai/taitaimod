...
public class ItemTntGun extends ShootableItem {
    ...
    public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int p_77663_4_, boolean p_77663_5_) {
        ...
        if (player.getItemBySlot(EquipmentSlotType.MAINHAND).getItem() == TaitaiModItems.TNT_GUN){
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_){
        ...
        if(!p_77659_1_.isClientSide && itemStack.getItem() == TaitaiModItems.TAMMO) {
            ItemStack ammo = new ItemStack(Items.AIR);
            AbstractArrowEntity ammoEntity = new TAmmoEntity(p_77659_1_, p_77659_2_, ammo);
