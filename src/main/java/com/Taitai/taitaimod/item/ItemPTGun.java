...
import com.Taitai.taitaimod.entity.PTAmmoEntity;
...
public class ItemPTGun extends ShootableItem {
    ...
    public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int p_77663_4_, boolean p_77663_5_) {
        ...
        if (player.getItemBySlot(EquipmentSlotType.MAINHAND).getItem() == TaitaiModItems.PT_GUN){
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_){
        ...
        AbstractArrowEntity ammoEntity = new PTAmmoEntity(p_77659_1_, p_77659_2_, ammo);
        ...
        if(!p_77659_1_.isClientSide && itemStack.getItem() == TaitaiModItems.STAMMO) {

            ammoEntity.shoot(v3.x, v3.y, v3.z, 100F, 0F);
