...
public class PTAmmoEntity extends AbstractArrowEntity {

    private double baseDamage = 0.24D;
    ...
    public PTAmmoEntity(EntityType<? extends PTAmmoEntity> p_i48546_1_, World p_i48546_2_) {
        super(p_i48546_1_, p_i48546_2_);
    }

    public PTAmmoEntity(World world, LivingEntity entity, ItemStack stack){
        super(TaitaiEntityTypes.PTAmmo.get(), entity, world);
    ...
    protected void doPostHurtEffects(LivingEntity p_184548_1_) {
        ...
        if (p_184548_1_.getType() == EntityType.ENDERMAN){
            ...
            p_184548_1_.hurt(DamageSource.playerAttack(player),10);
        }


        if (!level.isClientSide && p_184548_1_.getType() != EntityType.END_CRYSTAL){
            p_184548_1_.addEffect(new EffectInstance(Effects.GLOWING, 600, 0, false, false));
            p_184548_1_.addEffect(new EffectInstance(Effects.BLINDNESS, 100, 0, false, false));
