...
public class TAmmoEntity extends AbstractArrowEntity {

    private double baseDamage = 0.3D;
    private int knockback;
    private SoundEvent soundEvent = SoundEvents.IRON_GOLEM_STEP;
    private List<Entity> piercedAndKilledEntities;
    private ItemStack shootStack = new ItemStack(TaitaiModItems.TAMMO);
    private int ticksInGround;

    public TAmmoEntity(EntityType<? extends TAmmoEntity> p_i48546_1_, World p_i48546_2_) {
        super(p_i48546_1_, p_i48546_2_);
    }

    public TAmmoEntity(World world, LivingEntity entity, ItemStack stack){
        super(TaitaiEntityTypes.TAmmo.get(), entity, world);
    ...
    protected void doPostHurtEffects(LivingEntity p_184548_1_) {
        ...
        if (p_184548_1_.getType() == EntityType.ENDERMAN){
            ...
            p_184548_1_.hurt(DamageSource.playerAttack(player),15);
        }
