...
@OnlyIn(Dist.CLIENT)
public class TaitaiTntRenderer extends EntityRenderer<TaitaiTntEntity> {

    public TaitaiTntRenderer(EntityRendererManager p_i46134_1_) {
        super(p_i46134_1_);
        this.shadowRadius = 0.5F;
    }

    public void render(TaitaiTntEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(TaitaiTntEntity p_110775_1_) {
