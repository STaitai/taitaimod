...
import com.Taitai.taitaimod.entity.TaitaiTnt2Entity;
...
public class TaitaiTnt2Renderer extends EntityRenderer<TaitaiTnt2Entity> {

    public TaitaiTnt2Renderer(EntityRendererManager p_i46134_1_) {
        super(p_i46134_1_);
        this.shadowRadius = 0.5F;
    }

    public void render(TaitaiTnt2Entity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(TaitaiTnt2Entity p_110775_1_) {
