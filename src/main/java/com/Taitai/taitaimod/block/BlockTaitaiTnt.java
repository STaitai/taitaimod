...
public class BlockTaitaiTnt extends Block {

    public static final BooleanProperty UNSTABLE = BlockStateProperties.UNSTABLE;

    public BlockTaitaiTnt(AbstractBlock.Properties p_i48309_1_) {
        super(p_i48309_1_);
        this.registerDefaultState(this.defaultBlockState().setValue(UNSTABLE, Boolean.valueOf(false)));
        this.setRegistryName("taitai_tnt");
    }
    ...
    public void wasExploded(World p_180652_1_, BlockPos p_180652_2_, Explosion p_180652_3_) {
        if (!p_180652_1_.isClientSide) {
            TaitaiTntEntity taitaitntentity = new TaitaiTntEntity(p_180652_1_, (double)p_180652_2_.getX() + 0.5D, (double) p_180652_2_.getY(), (double)p_180652_2_.getZ() + 0.5D, p_180652_3_.getSourceMob());
            taitaitntentity.setFuse((short)(p_180652_1_.random.nextInt(taitaitntentity.getLife() / 4) + taitaitntentity.getLife() / 8));
            p_180652_1_.addFreshEntity(taitaitntentity);
        }
    }
    ...
    private static void explode(World p_196535_0_, BlockPos p_196535_1_, @Nullable LivingEntity p_196535_2_) {
        if (!p_196535_0_.isClientSide) {
            TaitaiTntEntity taitaitntentity = new TaitaiTntEntity(p_196535_0_, (double)p_196535_1_.getX() + 0.5D, (double)p_196535_1_.getY(), (double)p_196535_1_.getZ() + 0.5D, p_196535_2_);
            p_196535_0_.addFreshEntity(taitaitntentity);
            p_196535_0_.playSound((PlayerEntity)null, taitaitntentity.getX(), taitaitntentity.getY(), taitaitntentity.getZ(), SoundEvents.TNT_PRIMED, SoundCategory.BLOCKS, 1.0F, 1.0F);
        }
    }
